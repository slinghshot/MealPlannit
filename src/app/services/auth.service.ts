...
import { UserVerification } from '../interfaces/user-verification';
...
export class AuthService {
  ...
  userVerification(email: string, verificationCode: string){
    email=encodeURIComponent(email);
    return this.http.get<UserVerification>(`${this.apiAuth}/register?email=${email}&verification=${verificationCode}`)
  }
  checkIfToken() {
